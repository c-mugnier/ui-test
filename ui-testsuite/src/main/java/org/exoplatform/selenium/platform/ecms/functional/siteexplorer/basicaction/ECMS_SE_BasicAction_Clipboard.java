...
public class ECMS_SE_BasicAction_Clipboard extends PlatformBase {
	...
	public void test20_DeleteActionInClipboard()
	{
		...
		//goto Site Explorer
		navToolBar.goToSiteExplorer();
		cMenu.contextMenuAction(cMenu.ELEMENT_FILE_TITLE.replace("${titleOfFile}", DATA_CONTENT_FOLDER), cMenu.ELEMENT_ECMS_COPY_NODE);
		cMenu.contextMenuAction(cMenu.ELEMENT_FILE_TITLE.replace("${titleOfFile}", DATA_DOCUMENT_FOLDER), cMenu.ELEMENT_ECMS_CUT_NODE);
		cMenu.contextMenuAction(cMenu.ELEMENT_FILE_TITLE.replace("${titleOfFile}", DATA_FILE_NAME), cMenu.ELEMENT_ECMS_COPY_NODE);
		cMenu.contextMenuAction(cMenu.ELEMENT_FILE_TITLE.replace("${titleOfFile}", "Winter.jpg"), cMenu.ELEMENT_ECMS_CUT_NODE);
